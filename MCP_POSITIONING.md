...
- **2026-05-11 — uncommitted — Cursor S2 (sample stratification) — C2 substrate proven, integration depth weaker than Opus**
  ...
  - **Not yet shipped for this thread:** Cursor S3, after-S2.tsv DB snapshot (pre-computed in S2.md as 6 rows / 6,898 B; awaiting sqlite3 capture), screenshots/S2-remember.png (nice-to-have).
